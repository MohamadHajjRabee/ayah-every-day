...
const LangDropdown = () => {
    ...
    return(
        <div ref={dropdownDiv} className='absolute md:top-10 md:right-10 top-5 right-5 text-white py-1 pb-2 px-4 md:text-lg text-sm tracking-widest rounded-md z-50' style={{boxShadow: 'inset 2000px 0 0 0 rgb(0 0 0 / 50%)'}}>
            <div className='flex-row flex gap-5 justify-around items-center border-b-2 border-white py-1.5 hover:cursor-pointer' onClick={toggleDropdown}>
                <button>
                    {currentLanguage}
                </button>
            ...
            {
                activeDropdown &&
                <div className='flex-col items-start flex mt-2 mb-1'>
